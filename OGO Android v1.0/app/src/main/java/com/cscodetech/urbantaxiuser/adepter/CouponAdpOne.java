...
import com.customerogo.app.model.CouponItem;
...
public class CouponAdpOne extends RecyclerView.Adapter<CouponAdpOne.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        Glide.with(mContext).load(APIClient.baseUrl + "/" + coupon.getCImg()).thumbnail(Glide.with(mContext).load(R.drawable.clock)).into(holder.imgCode);
        Log.e("amount",amount+" "+coupon.getMinAmt());
        if (amount < coupon.getMinAmt()) {
            holder.txtApply.setTextColor(mContext.getResources().getColor(R.color.gray));
